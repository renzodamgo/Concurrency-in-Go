...
#define _nstates1	14	/* Turnomujeres */
#define minseq1	13
#define maxseq1	25
#define _endstate1	13

#define _nstates0	14	/* Turnohombres */
#define minseq0	0
#define maxseq0	12
...
#define PTurnomujeres	((P1 *)_this)
typedef struct P1 { /* Turnomujeres */
...
#define PTurnohombres	((P0 *)_this)
typedef struct P0 { /* Turnohombres */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
