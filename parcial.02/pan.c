...
iniglobals(int calling_pid)
{
		...
		now.genero = 0;
#ifdef VAR_RANGES
		logval("hombres", now.hombres);
		logval("mujeres", now.mujeres);
		logval("genero", now.genero);
#endif
}
...
{	/* int i; */
	printf("global vars:\n");
	printf("	byte   hombres:	%d\n", now.hombres);
	printf("	byte   mujeres:	%d\n", now.mujeres);
	printf("	byte   genero:	%d\n", now.genero);
}
void
